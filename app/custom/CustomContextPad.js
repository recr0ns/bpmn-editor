...
export default class CustomContextPad {
  ...
  getContextPadEntries(element) {
    ...
    return {
      ...
      'append.document-skill': getItem('context-document'),
      'append.classification-skill': getItem('context-classification'),
      'append.processing-skill': getItem('context-processing'),
      'append.manual-skill': getItem('context-manual'),
      'append.if-skill': getItem('context-if'),
      'append.connect-action': {
        group: 'actions',
        element: '<div class="context-item"></div>',
        title: translate('Append Task with low suitability score'),
        action: {
          click: appendServiceTask(SUITABILITY_SCORE_LOW),
          dragstart: appendServiceTaskStart(SUITABILITY_SCORE_LOW)
